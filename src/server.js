...
app.get('/profile', (req, res) => {
  const { idToken, accessToken } = req.session;
  const decodedIdToken = JSON.stringify(req.session.decodedIdToken);
  const decodedAccessToken = JSON.stringify(jwt.decode(accessToken));
  res.render('profile', {
    idToken,
    decodedIdToken,
    accessToken,
